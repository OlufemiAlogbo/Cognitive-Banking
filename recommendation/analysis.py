...
## correlating categorical and numeric features# grid = sns.FacetGrid(train_df, col='Embarked', hue='Survived', palette={0: 'k', 1: 'w'})
...
## Creating new feature extracted from existing
...
### Creating if passenger is travelling alone
for dataset in combine:
    dataset['IsAlone'] = 0
